...
public class ContentService {
    ...
    public List<ContentDto> getContentsByTierAndPlatform(ContentType contentType, Platform platform) {
        List<Object[]> results = contentRepository.findContentsWithTierAndPlatform(contentType.name(), platform.name());
